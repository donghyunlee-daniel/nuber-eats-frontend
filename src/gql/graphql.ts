...
export type Mutation = {
  ...
  createRestaurnat: CreateAccountOutput;
...
export type MutationCreateRestaurnatArgs = {
...
export type VerfiyEmailOutput = {
  __typename?: 'VerfiyEmailOutput';
  error?: Maybe<Scalars['String']['output']>;
  ok: Scalars['Boolean']['output'];
};
